...
public class LVLClient {
    ...
    public static void main(String args[]) throws IOException {
        ...
        System.out.println("Enter the managerID for Laval Client");
        Scanner sc = new Scanner(System.in);
        String managerID = sc.next();
        String prefix = managerID.substring(0,3);
        if (prefix.equals("LVL")) {
            ...
            while (true) {
                ...
                switch (ch) {
                    case 1:
                        ...
                        lvl.createTRecord(fname, lname, add, ph, spc, "LVL", managerID);
                    ...
                    case 2:
                        ...
                        lvl.createSRecord(firstName, lastName, CourseRegistered, status, statusDate, managerID);
                    ...
                    case 3:
                        ...
                        lvl.editRecord(recID, field, value, managerID);
                    ...
                    case 5:
                        ...
                        System.out.println(lvl.displayRecord(recordID, managerID));
                    ...
                    case 7:
                        ...
                        System.out.println(lvl.transferRecord(recorID, centServer, managerID));
                        if (centServer.equals("DDO") || centServer.equals("MTL")) {
                            LogObject.logger.info("The Manager " + managerID + " transferred the Record " + recorID + " to server " + centServer);
                        } else if (centServer.equals("LVL")) {
            ...
            System.out.println("LVL client is running, cannot use MTL and DDO");
    }
